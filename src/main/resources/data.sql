...
INSERT INTO Evenement(id, nom_evenement, description, lieu,  date_debut, date_fin) VALUES
    ...
    (5, 'finale Coupe du monde', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'Russie, Moscou, Stade Loujniki', TO_DATE('2018/07/15', 'yyyy/mm/dd'), TO_DATE('2018/07/15', 'yyyy/mm/dd'));
