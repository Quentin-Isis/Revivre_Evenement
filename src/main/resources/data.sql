...
INSERT INTO Evenement(id, nom_evenement, description, lieu,  date_debut, date_fin) VALUES
    ...
    (2, '8ème de finale Coupe du monde', 'Dans ce premier huitième de finale, la France affronte l Argentine qui est sortie in extremis de son groupe grâce à une victoire face au Nigeria obtenue dans les derniers instants...', 'Russie', TO_DATE('2018/06/30', 'yyyy/mm/dd'), TO_DATE('2018/07/03', 'yyyy/mm/dd')),
    (3, 'quart de finale Coupe du monde', 'La France se qualifie pour la sixième fois de son histoire pour les demi-finales de la Coupe du monde...', 'Russie', TO_DATE('2018/07/06', 'yyyy/mm/dd'), TO_DATE('2018/07/07', 'yyyy/mm/dd')),
    (4, 'demi finale Coupe du monde', 'La rencontre est très attendue par l ensemble des observateurs : la Belgique a produit jusque-là un niveau de jeu extrêmement séduisant, tourné vers l attaque (14 buts depuis le début de la compétition) et a réussi le tour de force d éliminer le Brésil, l un des grands favoris de la compétition...', 'Russie', TO_DATE('2018/07/10', 'yyyy/mm/dd'), TO_DATE('2018/07/11', 'yyyy/mm/dd')),
    (5, 'finale Coupe du monde', '« Mangés au milieu, transparents dans les duels, pauvres techniquement, incapables de se faire cinq passes », les Bleus souffrent en première période, face à des Croates à plus de 68 % de possession qui dictent le jeu, mais les joueurs de Didier Deschamps parviennent toutefois à atteindre la pause en menant 2-1...', 'Russie', TO_DATE('2018/07/15', 'yyyy/mm/dd'), TO_DATE('2018/07/15', 'yyyy/mm/dd'));
